      ...
      >
        ...
        >
          ...
          >
            ...
            <rect width="1000" height="1000" fill="#040813" />

            {/* Grid Pattern Overlay */}
            <rect width="1000" height="1000" fill="url(#radar-grid)" />
            ...
            <path d="M 320 960 C 350 820, 360 750, 380 700" fill="none" stroke="rgba(255, 255, 255, 0.12)" strokeWidth="1" strokeDasharray="3 3" />
            <path d="M 680 820 C 650 720, 680 650, 720 600" fill="none" stroke="rgba(255, 255, 255, 0.12)" strokeWidth="1" strokeDasharray="3 3" />
            <path d="M 380 700 C 450 550, 520 450, 580 400" fill="none" stroke="rgba(255, 255, 255, 0.12)" strokeWidth="1" strokeDasharray="3 3" />
            
            {/* Gauteng Economic Zone Highlight */}
            <path d="M 620 240 L 740 240 L 740 340 L 620 340 Z" fill="rgba(245, 158, 11, 0.08)" stroke="rgba(245, 158, 11, 0.4)" strokeWidth="1.2" strokeDasharray="2 2" />

            {/* Major Highway Arteries */}
            {/* N1 Corridor: Cape Town -> JHB -> Pretoria -> Musina */}
            <path d="M 130 920 L 260 780 L 480 520 L 680 280 L 800 80" fill="none" stroke="#f59e0b" strokeOpacity="0.4" strokeWidth="2" strokeDasharray="5 3" />
            {/* N2 Coastal Corridor: Cape Town -> Gqeberha -> East London -> Durban */}
            <path d="M 130 920 L 220 980 L 550 900 L 680 820 L 780 620" fill="none" stroke="#3b82f6" strokeOpacity="0.4" strokeWidth="2" strokeDasharray="5 3" />
            {/* N3 Corridor: JHB -> Durban */}
            <path d="M 680 280 L 780 620" fill="none" stroke="#10b981" strokeOpacity="0.4" strokeWidth="2" strokeDasharray="5 3" />

            {/* Financial Hub Target Rings */}
            {/* Gauteng Hub (Sandton / Pretoria) */}
            <circle cx="680" cy="280" r="75" fill="url(#gauteng-glow)" />
            <circle cx="680" cy="280" r="45" fill="none" stroke="#f59e0b" strokeWidth="1.2" strokeDasharray="4 4" />
            <circle cx="680" cy="280" r="90" fill="none" stroke="#f59e0b" strokeWidth="0.8" strokeDasharray="6 6" />

            {/* Cape Town Hub (V&A Waterfront) */}
            <circle cx="260" cy="780" r="60" fill="url(#cape-glow)" />
            <circle cx="260" cy="780" r="35" fill="none" stroke="#3b82f6" strokeWidth="1.2" strokeDasharray="4 4" />

            {/* Durban Hub (Umhlanga) */}
            <circle cx="780" cy="620" r="55" fill="url(#durban-glow)" />
            <circle cx="780" cy="620" r="30" fill="none" stroke="#10b981" strokeWidth="1.2" strokeDasharray="4 4" />
          </svg>
