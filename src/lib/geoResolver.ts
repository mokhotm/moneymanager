...
export const SA_MERCHANT_RULES: GeoMerchantRule[] = [
  ...
  {
    pattern: /car\s*service\s*city\s*spri/i,
    cleanMerchant: "Car Service City Springs",
    locationName: "5th Street, Springs Industrial / CBD",
    city: "Springs",
    suburb: "Springs Industrial",
    region: "Springs & Bakerton",
    lat: -26.2550,
    lng: 28.4350,
  ...
  {
    pattern: /ae\s*welgedacht|welgedacht\s*rd/i,
    cleanMerchant: "Astron Energy Welgedacht Rd",
    locationName: "Welgedacht Rd, Springs",
    city: "Springs",
    suburb: "Welgedacht",
    region: "Springs & Bakerton",
    lat: -26.2200,
