...
export const SA_MERCHANT_RULES: GeoMerchantRule[] = [
  ...
  },
  {
    ...
    cleanMerchant: "Holiday Inn Express Pretoria",
    locationName: "Cnr Steve Biko & Trevenna St, Sunnyside / Pretoria Central",
    city: "Pretoria",
    suburb: "Sunnyside",
    region: "Pretoria & Centurion",
    lat: -25.7548,
  ...
  },
  {
    ...
    cleanMerchant: "TotalEnergies Capital Park",
    locationName: "Venter St & Paul Kruger St, Capital Park, Pretoria",
    city: "Pretoria",
    suburb: "Capital Park",
    region: "Pretoria & Centurion",
    lat: -25.7320,
  ...
  {
    pattern: /shell\s*middels|shell\s*middelstraat/i,
    cleanMerchant: "Shell Middel Street Service Station",
    locationName: "Cnr Middel St & Florence Ribeiro Ave, Nieuw Muckleneuk, Pretoria",
    city: "Pretoria",
    suburb: "Nieuw Muckleneuk / Waterkloof",
    region: "Pretoria & Centurion",
    lat: -25.7728,
    lng: 28.2312,
    category: "Fuel & Transport",
