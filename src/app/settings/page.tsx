...
import { ExternalLink, CheckCircle2, AlertCircle, Loader2, Trash2, Eye, EyeOff } from "lucide-react";
    ...
    <>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Configure Bring Your Own Key (BYOK) LLMs, Agent Model Assignments &amp; Rules</p>
        </div>
      ...
      <div className="page-body">
        {loading ? (
          ...
          <>
            ...
            {/* 1. Configured AI Provider Keys (BYOK) */}
            <div className="card mb-6">
            ...
            {/* 2. Per-Agent Model Assignment Grid */}
            <div className="card mb-6">
